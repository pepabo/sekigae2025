...
/* {{{ void safe_key_int_shuffle(array &$array) */
...
/* {{{ arginfo
 */
ZEND_BEGIN_ARG_INFO(arginfo_safe_key_int_shuffle, 0)
	ZEND_ARG_ARRAY_INFO(1, array, 0) // 1 = pass by reference
ZEND_END_ARG_INFO()
/* }}} */

/* {{{ safe_key_int_shuffle_functions[]
 */
static const zend_function_entry safe_key_int_shuffle_functions[] = {
	PHP_FE(safe_key_int_shuffle, arginfo_safe_key_int_shuffle)
	PHP_FE_END
};
/* }}} */
...
zend_module_entry safe_key_int_shuffle_module_entry = {
	...
	safe_key_int_shuffle_functions,			/* zend_function_entry */
